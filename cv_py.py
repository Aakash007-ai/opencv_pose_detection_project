...
mp_pose = mp.solutions.pose #initialize mediapipe pose class.
...
def detectPose(image, pose, draw=False, display=False): #return input image with detected landmarks
    '''
